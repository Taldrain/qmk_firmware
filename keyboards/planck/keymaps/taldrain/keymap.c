 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | Alt  | Tab  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    KC_ESC,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,                KC_BSPC,
    KC_LCTRL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    LT(_MOUSE, KC_SCLN), KC_QUOT,
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,             KC_ENT,
    KC_ESC,   KC_LALT, KC_TAB,  KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,               KC_RGHT
),
...
[_MOUSE] = LAYOUT_planck_grid(
    _______, _______, KC_MS_U, _______, _______, _______, _______, _______, KC_BTN1, KC_BTN2, _______, _______,
